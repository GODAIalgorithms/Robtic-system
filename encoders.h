...
volatile long count_e1_right; // used by encoder to count the rotation
...
volatile long count_e0_left; // used by encoder to count the rotation
...
ISR( INT6_vect ) {
  ...
  // against the lecture slides.
   switch ( state ) {
      ...
      case 1:  count_e1_right++; break;  // clockwise?
      case 2:  count_e1_right--; break;  // anti-clockwise?
      case 3:              break;  // Invalid
      case 4:  count_e1_right--; break;  // anti-clockwise?
      case 5:              break;  // No movement.
      case 6:              break;  // Invalid
      case 7:  count_e1_right++; break;  // clockwise?
      case 8:  count_e1_right++; break;  // clockwise?
      case 9:              break;  // Invalid
      case 10:             break;  // No movement.
      case 11: count_e1_right--; break;  // anti-clockwise?
      case 12:             break;  // Invalid
      case 13: count_e1_right--; break;  // anti-clockwise?
      case 14: count_e1_right++; break;  // clockwise?
...
// This ISR handles just Encoder 0  ///////////////////count_e0_left
...
ISR( PCINT0_vect ) {
  ...
  // against the lecture slides.  
  switch( state ) {
  // else if(  { // ...etc  switch( state ) {
  case 0:              break; // No movement.
    case 1:  count_e0_left++; break;  // clockwise?
    case 2:  count_e0_left--; break;  // anti-clockwise?
    case 3:              break;  // Invalid
    case 4:  count_e0_left--; break;  // anti-clockwise?
    case 5:              break;  // No movement.
    case 6:              break;  // Invalid
    case 7:  count_e0_left++; break;  // clockwise?
    case 8:  count_e0_left++; break;  // clockwise?
    case 9:              break;  // Invalid
    case 10:             break;  // No movement.
    case 11: count_e0_left--; break;  // anti-clockwise?
    case 12:             break;  // Invalid
    case 13: count_e0_left--; break;  // anti-clockwise?
    case 14: count_e0_left++; break;  // clockwise?
    case 15:             break;  // No movement.
  }
